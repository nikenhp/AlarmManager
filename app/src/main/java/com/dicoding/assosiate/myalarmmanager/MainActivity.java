...
import static com.dicoding.assosiate.myalarmmanager.AlarmReceiver.TYPE_ONE_TIME;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_one_time_alarm_date){
            ...
            //Shared Preference untuk menyimpan data date dan time
            //mengambil data di alarm preference
